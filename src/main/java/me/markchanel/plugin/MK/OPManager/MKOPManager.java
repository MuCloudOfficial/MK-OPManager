...
import me.markchanel.plugin.MK.OPManager.Utils.Commands;
...
public class MKOPManager extends JavaPlugin {

    public static final String Prefix = ChatColor.YELLOW + "[" + ChatColor.AQUA + "MK-OPManager" + ChatColor.YELLOW + "] ";
