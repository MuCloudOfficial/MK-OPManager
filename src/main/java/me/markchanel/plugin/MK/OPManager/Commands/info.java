...
public class info{
    ...
    private void run_zh_CN(){
        ...
        Sender.sendMessage("§7§l| §6 /mkom delOP [玩家] [密码]                    清除一个管理员");
        Sender.sendMessage("§7§l| §6 /mkom addCommand [命令] [密码]               添加一个命令,它将会禁止被所有玩家执行(除超级管理外)");
        Sender.sendMessage("§7§l| §6 /mkom delCommand [命令] [密码]               从禁止命令中清除该命令");
        Sender.sendMessage("§7§l| §6 /mkom listOP                                     列出管理员名单");
